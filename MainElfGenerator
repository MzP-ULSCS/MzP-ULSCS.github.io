    ...
    <style>
        ...
        * {
        ...
        h1 {
            ...
            font-weight: 700;
            margin: 0 0 10px 0;
            font-size: 4rem; /* Slightly smaller to fit better */
            color: white;
        ...
        .output-box {
            ...
            /* Background settings */
            background-color: rgba(173, 216, 230, 0.85); /* Slightly more opaque */
        ...
        .elf-job-text {
            ...
            font-size: 2rem;
            font-weight: normal;
            color: #2e0052; /* Slightly darker/different for contrast */
        ...
        @media (max-width: 600px) {
            ...
            button.generate-btn { font-size: 1.4rem; padding: 8px 20px; }
            .elf-name-text { font-size: 2rem; }
            .elf-job-text { font-size: 1.4rem; }
            .output-box { padding: 1.5rem; min-height: 180px; }
        }
    </style>
</head>
<body>
